...
const translations = {
  ...
  'awards.2022.item1.en': 'In June 2022, BUD co-founder Risa Feng was selected as one of the "30 Under 30 Entrepreneurial Pioneers" by Cyzone, demonstrating the innovative vitality of the company\'s team.',
  ...
  'awards.2022.item3.zh': '同年，冯文慧入选福布斯"30 Under 30 - Asia - Consumer Technology"榜单，提升了BUD及Point One的国际知名度。',
  'awards.2022.item3.en': 'In the same year, Risa Feng was selected for the Forbes "30 Under 30 - Asia - Consumer Technology" list, enhancing the international reputation of BUD and Point One.',
  'awards.2023.title.zh': '2023年',
  'awards.2023.title.en': '2023',
  'awards.2023.item1.zh': '冯文慧登上《2023常熟昆承湖・胡润U30中国创业先锋》榜单，再次证明公司创新成果获认可。（2024年3月发布榜单）',
  'awards.2023.item1.en': 'Risa Feng was listed on the "2023 Changshu Kuncheng Lake - Hurun U30 China Entrepreneurial Pioneers" list, once again proving that the company\'s innovative achievements have been recognized. (List released in March 2024)',
